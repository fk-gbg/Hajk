...
class AttributeEditor extends React.Component {
  constructor(props) {
    ...
    this.subscriptions = [
      props.observer.subscribe("feature-selected-for-edit", (_vectorSource) => {
        this.setState({
          formValues: this.initFormValues() || {},
      ...
      props.observer.subscribe("feature-added", (_vectorSource) => {
        ...
        return (
          <>
            <StyledTextField
              ...
              slotProps={{
                htmlInput: { maxLength: field.maxLength || undefined },
              }}
  ...
  createAttributeForm() {
    ...
    if (
      ...
      if (model.editFeatureId) {
        const markup = model.editSource.editableFields.map((field, i) => {
